...
<body class=" border-top-wide border-primary d-flex flex-column">
  <div class="page page-center">
    <div class="container-tight">
      <div class="empty">
        <p class="empty-title">¡Sesión expirada!</p>
        <div style="margin: auto; margin-top: -90px; text-align: center">
          <img width="650" height="650" src="{{ Storage::url('images/errors/419-error.svg') }}" alt="">
        </div>
        <p class="empty-subtitle text-muted">
          "Lo sentimos, tu sesión ha expirado. Por razones de seguridad, tu sesión se cierra automáticamente después de un período de inactividad.<br>Por favor, vuelve a iniciar sesión para continuar."
        </p>
      </div>
