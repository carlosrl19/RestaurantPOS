...
<body class=" border-top-wide border-primary d-flex flex-column">
  <div class="container-tight">
    <div class="empty">
      <p class="empty-title" style="color: gray">¡Vaya, parece que algo salió mal!</p>
      <div style="margin: auto; margin-top: -10px; text-align: center">
        <img width="700" height="700" src="{{ Storage::url('images/errors/404-error.png') }}" alt="">
      </div>
      <p style="color: gray;">
        "Oops, parece que la página que estás buscando no existe. Por favor, intenta nuevamente dentro de un momento,<br>si el problema persiste contacta al soporte técnico para que puedan solucionarlo."
      </p>
