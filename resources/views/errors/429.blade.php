    ...
    <div class="container-tight">
      <div class="empty">
        ...
        <div style="margin: auto; margin-top: -10px; text-align: center">
          <img width="700" height="700" src="{{ Storage::url('images/errors/403-error.png') }}" alt="">
        </div>
        <p class="empty-subtitle text-muted">
          "Has realizado demasiados intentos de inicio de sesión, debido a esto y por seguridad, tu usuario se bloqueará por un momento. Si tienes problemas con el acceso, pide ayuda al equipo de desarrollo."
        </p>
      </div>
