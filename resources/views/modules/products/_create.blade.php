                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('product_name') is-invalid @enderror"
                                                ...
                                                minlength="3" maxlength="40" oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9 ., -Ñ]/g, '')">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <div class="form-floating">
                                            <input type="number" class="form-control @error('product_buy_price') is-invalid @enderror"
                                                id="product_buy_price" name="product_buy_price" value="{{ old('product_buy_price') }}" step="any">
                                            <label for="product_buy_price" class="form-label">Precio compra <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <div class="form-floating">
                                            <input type="number" class="form-control @error('product_sell_price') is-invalid @enderror"
                                                id="product_sell_price" name="product_sell_price" value="{{ old('product_sell_price') }}" step="any">
                                            <label for="product_sell_price" class="form-label">Precio venta <span class="text-danger">*</span></label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12">
                                        <div class="form-floating">
                                            <textarea oninput="this.value = this.value.toUpperCase()" class="form-control @error('product_description') is-invalid @enderror" id="product_description" name="product_description"
                                                style="resize: none; height: 100px; font-size: clamp(0.7rem, 3vh, 0.8rem);" minlength="5" maxlength="100">{{old('product_description')}}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        <div class="form-floating">
                                            <input type="number" class="form-control @error('product_stock') is-invalid @enderror" id="product_stock" name="product_stock" value="{{ old('product_stock') }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-floating">
                                            <input type="text" oninput="this.value = this.value.replace(/\D/g, '')" class="form-control @error('product_barcode') is-invalid @enderror" id="product_barcode" name="product_barcode" value="{{ old('product_barcode') }}"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="text-center">
                                                    <img id="product_image_preview_create" src="{{ Storage::url('images/resources/no_image_available.png') }}" style="object-fit: contain;" class="rounded" width="280" height="280">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
