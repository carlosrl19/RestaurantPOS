              ...
              @enderror
                ...
                <div class="row mb-3">
                  <div class="col-sm-6 form-floating mb-3">
                    <input type="number" step="any" class="form-control @error('product_buy_price') is-invalid @enderror"
                           id="product_buy_price" name="product_buy_price" value="{{ old('product_buy_price') }}">
                  ...
                  <div class="col-sm-6 form-floating mb-3">
                    <input type="number" step="any" class="form-control @error('product_sell_price') is-invalid @enderror"
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-6 form-floating mb-3">
                    <input type="text" class="form-control @error('product_barcode') is-invalid @enderror"
                           id="product_barcode" name="product_barcode"
                           value="{{ old('product_barcode') }}" minlength="4" maxlength="13"
                           oninput="this.value = this.value.replace(/\D/g, '')">
                    <label for="product_barcode">Código barra</label>
