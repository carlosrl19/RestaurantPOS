<div class="modal fade" id="create_provider" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white fw-bold">
                <p class="modal-title" id="exampleModalLabel">Crear nuevo proveedor</p>
            </div>
            <div class="modal-body">
                <form action="{{ route('proveedor.store')}}" method="POST" enctype="multipart/form-data" novalidate autocomplete="off">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" oninput="this.value = this.value.toUpperCase().replace(/[^A-Z\s]/g, '')" class="form-control @error('provider_contact_name') is-invalid @enderror" id="provider_contact_name"
                                    name="provider_contact_name" value="{{ old('provider_contact_name') }}" maxlength="55">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" oninput="this.value = this.value.replace(/\D/g, '')" class="form-control @error('provider_contact_phone') is-invalid @enderror" id="provider_contact_phone"
                                    name="provider_contact_phone" value="{{ old('provider_contact_phone') }}" maxlength="8">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input type="text" oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9 ]/g, '')" class="form-control @error('provider_company_name') is-invalid @enderror" id="provider_company_name"
                                    name="provider_company_name" value="{{ old('provider_company_name') }}" maxlength="55">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" oninput="this.value = this.value.replace(/\D/g, '')" class="form-control @error('provider_company_phone') is-invalid @enderror" id="provider_company_phone"
                                    name="provider_company_phone" value="{{ old('provider_company_phone') }}" maxlength="8">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" oninput="this.value = this.value.replace(/\D/g, '')" class="form-control @error('provider_company_rtn') is-invalid @enderror" id="provider_company_rtn"
                                    name="provider_company_rtn" value="{{ old('provider_company_rtn') }}"
                                    maxlength="14">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="form-floating">
                                <textarea oninput="this.value = this.value.toUpperCase()" class="form-control @error('provider_company_address') is-invalid @enderror"
                                    id="provider_company_address" name="provider_company_address"
                                    maxlength="255" style="resize: none; height: 100px; font-size: clamp(0.7rem, 3vh, 0.8rem);">{{ old('provider_company_address') }}</textarea>
