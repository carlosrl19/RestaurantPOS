                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <button style="display: flex; margin: auto; font-size: clamp(0.8rem, 3vw, 0.9rem);" type="button" class="btn btn-sm btn-danger" id="cierre_diario_btn" data-toggle="modal" data-target="#cierre_diario_modal">
                                    Exportar a PDF
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <button style="display: flex; margin: auto; font-size: clamp(0.8rem, 3vw, 0.9rem);" type="button" class="btn btn-sm btn-danger" id="cerrarCajaMensualBtn" onclick="exportarPDF()">
                                    Exportar a PDF
                                </button>
                            </div>
                        </div>
