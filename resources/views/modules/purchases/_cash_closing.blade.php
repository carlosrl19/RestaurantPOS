    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger" style="color: white; font-size: clamp(0.7rem, 3vw, 1rem);">
                <p class="modal-title fw-bold" id="cierreCajaModalLabel">Cierre de caja - compras</p>
            </div>
            <div class="modal-body" style="font-size: clamp(0.8rem, 3vw, 0.9rem);">
                <div class="form-group row">
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <button data-dismiss="modal" style="display: flex; margin: auto; font-size: clamp(0.8rem, 3vw, 0.9rem);" type="button" class="btn btn-sm btn-danger" id="cierre_diario_btn" data-toggle="modal" data-target="#cierre_diario_modal">
                                    Exportar a PDF
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <button data-dismiss="modal" style="display: flex; margin: auto; font-size: clamp(0.8rem, 3vw, 0.9rem);" type="button" class="btn btn-sm btn-danger" id="cerrarCajaMensualBtn" onclick="exportarPDF()">
                                    Exportar a PDF
                                </button>
                            </div>
                        </div>
