    ...
    <div id="page_pdf">
        <header style="background-color:rgba(255, 0, 0, 0.64); display: flex; justify-content: space-between; align-items: center; border: 2px solid #ddd; border-radius: 10px; padding: 10px; margin-bottom: 20px; margin-top: 5px; overflow: hidden;">
            <div style="text-align: right; margin-top: 10px; margin-bottom: 10px; padding: 20px;">
                ...
                <h1 style="font-size: 20pt; text-decoration: underline; font-style: italic; margin: 0; font-weight: bold; color: rgba(255,255,255,0.3);">COMPRAS - CIERRE MENSUAL</h1>
        ...
        <h4 style="text-align: right;">LISTADO DE PRODUCTOS COMPRADOS EN EL MES (<?php echo $meses[$mesSeleccionado - 1]; ?> - {{ \Carbon\Carbon::now()->format('Y') }})</h4>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tbody style="font-size: 0.7rem;">
                ...
                <tr>
                    ...
                    <td style="text-align: center; color: gray; text-transform: uppercase; font-size: 7pt">{{ $compra->user->name }}</td>
                    <td style="text-align: center; font-size: 7pt; max-width: 20px">{{ $compra->created_at->format('d-m-Y h:i:s') }}</td>
                    <td style="text-align: center; font-size: 7.7pt; max-width: 50px; word-wrap: break-word;">{{ $detalle->producto->product_name }}</td>
                    <td style="text-align: center;">{{ $detalle->cantidad_detalle_compra }}</td>
                ...
                <tr>
                    <td colspan="7" style="text-align: center;">
                        No existen compras registradas este mes para ser mostradas.
                    </td>
                </tr>
                @endif
            </tbody>
