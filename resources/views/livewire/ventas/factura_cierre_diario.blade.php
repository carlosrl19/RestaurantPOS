<title>Ventas (Cierre diario) - {{ $fecha }} </title>
    ...
    <div id="page_pdf">
        <header style="background-color: rgba(0, 89, 255, 0.64); display: flex; justify-content: space-between; align-items: center; border: 2px solid #ddd; border-radius: 10px; padding: 10px; margin-bottom: 20px; margin-top: 5px; overflow: hidden;">
            <div style="text-align: right; margin-top: 10px; margin-bottom: 10px; padding: 20px;">
                ...
                <h1 style="font-size: 20pt; text-decoration: underline; font-style: italic; margin: 0; font-weight: bold; color: rgba(255,255,255,0.3);">VENTAS - CIERRE DIARIO</h1>
                <h1 style="font-size: 15pt; margin: 10px 0 0 0; font-weight: bold; color: white;">{{ config('app.name') }}</h1>
                <p style="margin: 5px 0 0 0; font-size: 9pt; color: white"><strong>Fecha cierre:</strong>&nbsp;&nbsp;{{ $fecha }}</p>
        ...
        <h4 style="text-align: right;">LISTADO DE PRODUCTOS VENDIDOS ({{ $fecha }})</h4>

        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <thead style="background-color: rgba(0, 89, 255, 0.64); color: #fff;">
                <tr>
                    <th style="padding: 10px; text-align: center;">Nº</th>
                    <th style="padding: 10px; text-align: center;">EMPLEADO</th>
            ...
            <tbody style="font-size: 0.7rem;">
                ...
                @else
                <tr>
                    <td colspan="6" style="text-align: center;">No existen ventas registradas este día para ser mostradas.</td>
                </tr>
                @endif
            </tbody>
            <tfoot>
