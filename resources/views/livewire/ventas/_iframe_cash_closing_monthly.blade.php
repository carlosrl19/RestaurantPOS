    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header fw-bold">
                <p class="modal-title" id="pdfModalLabel">Ventas (previsualización de cierre mensual)</p>
...
<script>
    function exportarPDF() {
        const mesSeleccionado = document.getElementById('fechaCierreMensual').value; // Obtener el mes seleccionado
        const url = `/generar-factura-mes-actual?fechaCierreMensual=${mesSeleccionado}`; // Generar la URL
