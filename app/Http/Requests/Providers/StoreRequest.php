...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'provider_company_name' => 'required|string|min:3|max:55|regex:/^[^\d]+$/|unique:proveedors',
    ...
    public function messages()
    {
        return [
            ...
            'provider_company_rtn.regex' => 'El RTN de la empresa proveedora debe contener únicamente números.',
