...
class UpdateRequest extends FormRequest
{
    ...
    {
        return [
            'product_barcode' => 'nullable|string|regex:/^[0-9]+$/|min:4|max:13',
            Rule::unique('productos')->ignore($this->id),
            ...
            'max:999999999',
            'product_image' => 'image|mimes:jpeg,png,jpg,webp|max:8192' // Default (images/products/.no_image_available.png)
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'product_buy_price.min' => 'El precio de compra debe ser superior a L. 0.00.',
